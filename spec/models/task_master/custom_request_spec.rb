module TaskMaster
  RSpec.describe CustomRequest do
    ...
    it "validates that each custom_field is valid" do
      @request.custom_fields = [FactoryGirl.build(:task_master_custom_request_field)]
      @request.valid?
      expect(@request.errors[:custom_fields]).to be_empty
      @request.custom_fields = [FactoryGirl.build(:task_master_custom_request_field_invalid)]
      @request.valid?
    ...
    it "has a factory that can build a valid instance" do
      @request = FactoryGirl.build(:task_master_custom_request)
    ...
    it "has a method to trigger a callback" do
      @request = FactoryGirl.build(:task_master_custom_request, key: "ABCD")
      client = Client.new
